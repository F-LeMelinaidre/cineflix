        ...
        <div class="col-lg-6 col-md-12 order-0 order-lg-1 py-4 mx-auto">
            ...
            <form action="<?= self::$_Router->getUrl('signin') ?>" method="post" class="row flex-column row-gap-2 mx-auto ">
                ...
                <div class="col-xl-6 col-lg-8 col-md-8 col-sm-7 col-9 row mx-auto">
                    ...
                    <input type="email" id="Identifiant" name="email" class="form-control mb-2 w-100" aria-required="true" value="<?php if(isset($form['email'])) echo $form['email']
                    ?>">
                ...
                <div class="col-xl-6 col-lg-8 col-md-8 col-sm-7 col-9 row mx-auto">
                    ...
                    <input type="password" id="Password" name="password" class="form-control mb-2 w-100" min="8" value="<?php if(isset($form['password'])) echo
                    $form['password'] ?>">
