...
<section class="container d-flex justify-content-center row-gap-4 column-gap-4 flex-wrap mt-4">
    ...
    <div class="card card-info">
        <div class="bill-container">
            <a href="<?= self::$_Router->getUrl("movie_show",['slug' => $movie->slug, 'id' => $movie->id]) ?>">
                <img src="<?= $movie->affiche ?>" alt="la bête" class="bill card-img-top">
            </a>
        </div>
        <div class="card-body border-top py-1">
            <h5 class="card-title">
                <a href="<?= self::$_Router->getUrl("movie_show",['slug' => $movie->slug, 'id' => $movie->id]) ?>" class="link-warning link-offset-1
