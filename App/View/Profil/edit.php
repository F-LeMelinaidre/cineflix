...
<section id="Profil" class="edit-profil container d-flex justify-content-center row-gap-4 column-gap-4 flex-wrap mt-4">
    <form class="container col-6" action="#">
        <div class="identite">
            <h2>Identité :</h2>
        ...
        <div class="adresse">
            ...
            <div class="row justify-content-center">
                <div class="col-md-2 col-sm-2 col-2">
                    ...
                    <input type="text" name="numero_voie" class="form-control mb-2">
                </div>
                <div class="col-md-3 col-sm-3 col-3">
                    <label class="type-voie">Type :</label>
                    <input type="text" name="type_voie" class="form-control mb-2">
                </div>
                <div class="col-md-7 col-sm-7 col-7">
                    <label class="nom-voie">Nom de la voie :</label>
                    <input type="text" name="nom_voie" class="form-control mb-2">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-3">
                    <label class="code-postale">Code postale :</label>
                    <input type="text" name="cp" class="form-control mb-2">
                </div>
                <div class="col-9">
